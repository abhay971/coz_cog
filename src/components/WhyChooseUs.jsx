const WhyChooseUs = () => {
  const features = [
    ...
    "Certified quality machinery across all categories",
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
          ...
          <div className="space-y-6 md:space-y-8 scroll-animate-left">
            ...
            <p className="text-black text-base sm:text-lg leading-relaxed">
              With over a decade of experience in international machinery
              trading, we connect buyers and sellers across 50+ countries. Our
              commitment to quality, transparency, and timely delivery has made
              us a trusted name in the Defence, Industrial, Construction, and
              Agriculture sectors.
            </p>
            ...
            <div className="space-y-3 md:space-y-4">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <span className="text-black text-sm sm:text-base md:text-lg font-medium">
                    {feature}
                  </span>
                </div>
              ))}
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 scroll-animate-right">
            ...
            <div className="group bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg md:shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-100">
              ...
              <div className="p-3 sm:p-4 md:p-6 text-center">
                <h3 className="text-base sm:text-lg md:text-2xl font-bold text-black mb-1 md:mb-2 h-14 md:h-16 flex items-center justify-center leading-tight">
                  Defence
                  <br /> Machinery
                </h3>
                <p className="text-black text-xs sm:text-sm mb-2 md:mb-4 line-clamp-2">
            ...
            <div className="group bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg md:shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-100">
              ...
              <div className="p-3 sm:p-4 md:p-6 text-center">
                <h3 className="text-base sm:text-lg md:text-2xl font-bold text-black mb-1 md:mb-2 h-14 md:h-16 flex items-center justify-center leading-tight">
                  Industrial
                  <br className="md:hidden" /> Machinery
                </h3>
                <p className="text-black text-xs sm:text-sm mb-2 md:mb-4 line-clamp-2">
                  Mining equipment and generators
                </p>
                <button className="bg-[#F37E3A] hover:bg-[#d66d2f] text-white px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 text-xs sm:text-sm md:text-base rounded-full font-semibold transition-all shadow-md w-full sm:w-auto">
                  View Products
                </button>
            ...
            <div className="group bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg md:shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-100">
              ...
              <div className="p-3 sm:p-4 md:p-6 text-center">
                ...
                <p className="text-black text-xs sm:text-sm mb-2 md:mb-4 line-clamp-2">
                  Tractors, harvesters, and farm tools
                </p>
                <button className="bg-[#F37E3A] hover:bg-[#d66d2f] text-white px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 text-xs sm:text-sm md:text-base rounded-full font-semibold transition-all shadow-md w-full sm:w-auto">
                  View Products
                </button>
